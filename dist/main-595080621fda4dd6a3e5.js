...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__qwery__ = __webpack_require__("./assets/qwery.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bean__ = __webpack_require__("./assets/bean.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__viewport__ = __webpack_require__("./assets/components/popup/viewport.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__popup__ = __webpack_require__("./assets/components/popup/popup.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Manager = function () {
    function Manager() {
        ...
        var mode = __WEBPACK_IMPORTED_MODULE_0_query_string___default.a.parse(location.search)['mode'] || 2;
        this._mode = ['', 'hideViewportScrollbars'][mode - 1];
        if (this.mode() == 'hideViewportScrollbars') this._viewport = new __WEBPACK_IMPORTED_MODULE_3__viewport__["a" /* default */]();
    }
    ...
    _createClass(Manager, [{
        ...
        value: function adopt(popup) {
            ...
            this._popup.options({
                ...
                afterShow: function afterShow() {
                    ...
                    __WEBPACK_IMPORTED_MODULE_2__bean__["a" /* default */].on(window, 'keydown', _this._keydownEventHandler);
                    _this._resizeEventHandler = _this._resizeEventHandler.bind(_this);
                    __WEBPACK_IMPORTED_MODULE_2__bean__["a" /* default */].on(window, 'resize', _this._resizeEventHandler);
                    __WEBPACK_IMPORTED_MODULE_2__bean__["a" /* default */].fire(popupManager, 'afterShow');
                },
                onUpdateExtents: function onUpdateExtents(event) {
                    if (event != 'windowResize') __WEBPACK_IMPORTED_MODULE_2__bean__["a" /* default */].fire(popupManager, 'updateExtents', event);
                },
                beforeDestroy: function beforeDestroy() {
                    __WEBPACK_IMPORTED_MODULE_2__bean__["a" /* default */].fire(popupManager, 'beforeDestroy');
                    __WEBPACK_IMPORTED_MODULE_2__bean__["a" /* default */].off(window, 'keydown', _this._keydownEventHandler);
                    __WEBPACK_IMPORTED_MODULE_2__bean__["a" /* default */].off(window, 'resize', _this._resizeEventHandler);
                },
                afterDestroy: function afterDestroy() {
                    _this._popup = null;
                    if (_this.mode() == 'hideViewportScrollbars') _this._viewport.showScrollbars();
                    __WEBPACK_IMPORTED_MODULE_2__bean__["a" /* default */].fire(popupManager, 'afterDestroy');
                }
            });
        }
    }, {
        ...
        value: function _resizeEventHandler() {
            ...
            __WEBPACK_IMPORTED_MODULE_2__bean__["a" /* default */].fire(popupManager, 'updateExtents', 'windowResize');
        }
    }, {
        key: 'pageXOffset',
...
var Popup = function () {
    function Popup() {
        ...
        this.$el.attr('class', ['b-popup'].concat([this.options('mode') == 'hideViewportScrollbars' ? 'position-static' : 'position-fixed'], this.options('class') instanceof Array ? this.options('class') : [this.options('class')]).join(' '));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__qwery__ = __webpack_require__("./assets/qwery.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__bean__ = __webpack_require__("./assets/bean.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_popup_manager__ = __webpack_require__("./assets/components/popup/manager.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_popup_popup__ = __webpack_require__("./assets/components/popup/popup.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_link_button__ = __webpack_require__("./assets/components/link-button.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var $basketPopupLink = Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])('.basket-popup-link');
var $textareaPopupLink = Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])('.textarea-popup-link');
var $modeLink = Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])('.mode-link');
var $allButFooter = Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])('.all-but-footer');
var $contentTextarea = Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])('#content-textarea');
var $footer = Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])('footer');
...
var BasketPopup = function (_Popup) {
    ...
    function BasketPopup() {
        ...
        var _this = _possibleConstructorReturn(this, (BasketPopup.__proto__ || Object.getPrototypeOf(BasketPopup)).call(this, {
            ...
            title: 'Basket',
            content: '<table class="b-basket-popup-content">' + '<tr><td><span class="delete-button">&#x00d7;</span>' + '<td><img src="http://via.placeholder.com/50x50">' + '<td><a href="#">Item 1</a>' + '<tr><td><span class="delete-button">&#x00d7;</span>' + '<td><img src="http://via.placeholder.com/50x50">' + '<td><a href="#">Item 2</a>' + '</table>',
            buttons: {
                mainButton: {
                    role: 'button',
                    label: 'Place Order',
            ...
            afterShow: function afterShow() {
                Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])('tr a', $popupContent)[0].focus();
            }
        }));

        var $popupContent = Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])('.b-basket-popup-content', _this.$el);
        Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])('.delete-button', $popupContent).each(function (deleteButton) {
            new __WEBPACK_IMPORTED_MODULE_7__components_link_button__["a" /* default */](deleteButton);
        });
        __WEBPACK_IMPORTED_MODULE_4__bean__["a" /* default */].on($popupContent[0], 'press', '.delete-button', function (e) {
            if (e.detail.key == 'Enter') __WEBPACK_IMPORTED_MODULE_5__components_popup_manager__["a" /* default */].enterHasBeenHandled(true);
            if (Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])('tr', $popupContent).length > 1) Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])(e.target).parent('tr').remove();else _this.destroy();
        });
        return _this;
    }

    return BasketPopup;
}(__WEBPACK_IMPORTED_MODULE_6__components_popup_popup__["a" /* default */]);

__WEBPACK_IMPORTED_MODULE_4__bean__["a" /* default */].on($basketPopupLink[0], 'click', function () {
    new BasketPopup();
});
...
var TextareaPopup = function (_Popup2) {
    ...
    function TextareaPopup() {
        ...
        var _this2 = _possibleConstructorReturn(this, (TextareaPopup.__proto__ || Object.getPrototypeOf(TextareaPopup)).call(this, {
            ...
            title: 'Message',
            content: '<textarea id="popup-textarea" class="b-textarea-popup-content">' + '</textarea>',
            buttons: {
                mainButton: {
                    role: 'button',
                    label: 'Ok',
        ...
        var $popupContent = Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])('.b-textarea-popup-content', _this2.$el);
...
__WEBPACK_IMPORTED_MODULE_4__bean__["a" /* default */].on($textareaPopupLink[0], 'click', function () {
    new TextareaPopup();
});

var otherMode = __WEBPACK_IMPORTED_MODULE_5__components_popup_manager__["a" /* default */].mode() == 'hideViewportScrollbars' ? 1 : 2;
$modeLink.text('-> mode ' + otherMode);
$modeLink.attr('href', location.pathname + '?' + __WEBPACK_IMPORTED_MODULE_1_query_string___default.a.stringify({ mode: otherMode }));
$modeLink.removeClass('invisible');

var positionFooter = void 0;
if (__WEBPACK_IMPORTED_MODULE_5__components_popup_manager__["a" /* default */].mode() == 'hideViewportScrollbars') {
    positionFooter = function positionFooter(event) {
        ...
        var minHeight = (__WEBPACK_IMPORTED_MODULE_5__components_popup_manager__["a" /* default */].popupShown() ? __WEBPACK_IMPORTED_MODULE_5__components_popup_manager__["a" /* default */].pageYOffset() : 0) + __WEBPACK_IMPORTED_MODULE_5__components_popup_manager__["a" /* default */].viewportClientHeight() - $footer[0].offsetHeight;
        $allButFooter.css('min-height', minHeight > 0 ? minHeight + 'px' : '');
    };
    __WEBPACK_IMPORTED_MODULE_4__bean__["a" /* default */].on(window, 'resize', function () {
        positionFooter('resize');
    });
    __WEBPACK_IMPORTED_MODULE_4__bean__["a" /* default */].on(__WEBPACK_IMPORTED_MODULE_5__components_popup_manager__["a" /* default */], 'afterDestroy', function () {
        positionFooter('afterDestroy');
    });
} else {
    var updateSiteMinWidth = function updateSiteMinWidth(event) {
        document.body.style.minWidth = event == 'updateExtents' ? Math.max(minSiteWidth, window.pageXOffset + __WEBPACK_IMPORTED_MODULE_5__components_popup_manager__["a" /* default */].popupBoundingClientRect()['right']) + 'px' : '';
    };

    var minSiteWidth = parseFloat(Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])(document.body).css('min-width'));

    __WEBPACK_IMPORTED_MODULE_4__bean__["a" /* default */].on(__WEBPACK_IMPORTED_MODULE_5__components_popup_manager__["a" /* default */], 'updateExtents', function () {
    ...
    positionFooter = function positionFooter(event) {
        var minHeight = event == 'updateExtents' ? Math.max(document.documentElement.clientHeight, window.pageYOffset + __WEBPACK_IMPORTED_MODULE_5__components_popup_manager__["a" /* default */].popupBoundingClientRect()['bottom']) - $footer[0].offsetHeight : document.documentElement.clientHeight - $footer[0].offsetHeight;
        $allButFooter.css('min-height', minHeight > 0 ? minHeight + 'px' : '');
    };
    __WEBPACK_IMPORTED_MODULE_4__bean__["a" /* default */].on(__WEBPACK_IMPORTED_MODULE_5__components_popup_manager__["a" /* default */], 'updateExtents', function () {
...
__WEBPACK_IMPORTED_MODULE_2__common__["b" /* onTextareaResize */](function (textarea) {
    var $textarea = Object(__WEBPACK_IMPORTED_MODULE_3__qwery__["a" /* default */])(textarea);
...
//# sourceMappingURL=main-595080621fda4dd6a3e5.js.map